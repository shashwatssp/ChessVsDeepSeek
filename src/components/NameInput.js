...
const NameInput = () => {
    ...
    return (_jsxs(motion.div, { className: "name-input", initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { duration: 1 }, children: [_jsx("h1", { children: "Chess vs DeepSeek" }), _jsxs("div", { className: "input-section", children: [_jsx("h2", { children: "Enter Your Name:" }), _jsx("input", { type: "text", placeholder: "Enter your name", value: name, onChange: (e) => setName(e.target.value) }), _jsx("button", { onClick: handleStartGame, children: "Play" })] }), _jsxs("div", { className: "match-stats", children: [_jsx("h2", { children: "STATISTICS" }), loading ? (_jsx(ClipLoader, { size: 30, color: "#4A90E2", loading: loading })) : winStats ? (_jsxs("p", { children: ["Humans: ", _jsx("strong", { children: winStats.humanWins }), " wins (", totalGames > 0 ? ((winStats.humanWins / totalGames) * 100).toFixed(1) : 0, "%)", _jsx("br", {}), "DeepSeek: ", _jsx("strong", { children: winStats.aiWins }), " wins (", totalGames > 0 ? ((winStats.aiWins / totalGames) * 100).toFixed(1) : 0, "%)", _jsx("br", {}), "Draws: ", _jsx("strong", { children: winStats.draw }), " (", totalGames > 0 ? ((winStats.draw / totalGames) * 100).toFixed(1) : 0, "%)"] })) : (_jsx("p", { children: "Failed to load stats" }))] }), _jsxs("div", { className: "total-moves", children: [_jsx("h2", { children: "Total Moves Played:" }), loading ? (_jsx(ClipLoader, { size: 30, color: "#4A90E2", loading: loading })) : (_jsx("p", { children: totalMoves !== null ? totalMoves : 'Failed to load moves' }))] }), _jsxs("div", { className: "leaderboard", children: [_jsx("h2", { children: "Leaderboard" }), fetchError ? (_jsx("p", { children: "Feature rolling out soon" })) : loading ? (_jsx(ClipLoader, { size: 30, color: "#4A90E2", loading: loading })) : leaderboard.length > 0 ? (_jsx("ul", { children: leaderboard.slice(0, 3).map((player, index) => (_jsxs("li", { children: [index + 1, ".", " ", _jsx("strong", { children: player.name === 'DeepSeek'
